...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/botorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10399&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/botorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `botorch` can be installed with:

```
conda install botorch
```

It is possible to list all of the versions of `botorch` available on your platform with:
